package com.my.spring04.file.view;
 ...
 *	  [View를 만들어서 동작시키는 방법]
 * 
 * 	- AbstractView 추상클래스를 상속받아서 클래스를 정의함
 * 	- @Component("bean 이름")어노테이션을 붙여서 이름이 있는 bean이 되도록 함
 * 	- Servlet.context.xml에 BeanNameviewResolver 설정을 추가함
 */

//Component scan을 통해서 bean이 될 수 있도록 함 
