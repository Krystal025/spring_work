	...
	<c:choose>
		...
		<c:otherwise>
			...
			<c:if test="${tmp.num ne tmp.comment_group }">
				<li id="reli${tmp.num }" class="page-${pageNum}" style="padding-left: 50px;"><svg
						class="reply-icon" xmlns="http://www.w3.org/2000/svg" width="16"
						height="16" fill="currentColor" class="bi bi-arrow-return-right"
						viewBox="0 0 16 16">
			...
			<c:if test="${tmp.writer eq id }">
				<form id="updateForm${tmp.num }" class="comment-form update-form"
					action="comment_update" method="post">
