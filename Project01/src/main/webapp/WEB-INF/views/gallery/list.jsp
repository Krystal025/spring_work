...
<div class="container mt-3">
	<ul>
		...
		<li><a href="${pageContext.request.contextPath}/gallery/upload_form">사진 업로드</a></li>
		<br />
		<li><a href="${pageContext.request.contextPath}/gallery/upload_form2">사진 업로드2</a></li>
		<br />
		<li><a href="${pageContext.request.contextPath}/gallery/upload_form3">사진 업로드3</a></li>
	</ul>
      <h3>♡갤러리 목록♡</h3>
      <div class="row">
