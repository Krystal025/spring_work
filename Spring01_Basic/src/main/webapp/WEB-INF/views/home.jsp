...
<body>
	<div class="container">
		...
		<ul>
			...
			<li><a href="${pageContext.request.contextPath }/member/delete?num=1">작업후 리다이렉트 응답받기1</a></li>
			<li><a href="${pageContext.request.contextPath }/member/delete?num=1">작업후 리다이렉트 응답받기2</a></li>
