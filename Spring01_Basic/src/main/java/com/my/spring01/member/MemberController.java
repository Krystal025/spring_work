package com.my.spring01.member;
...
import com.my.spring01.MemberDto;
...
public class MemberController {
	...
	public String delete(int num) {
		...
		/*
		 * 리다이렉트 응답시에는 "redirect: 새로요쳥할 경로" 형식으로 view page정보를 작성하면 됨
		 */
		return "redirect:/";
	}
	
	
	// "/member/insertform" 요청을 처리할 메소드 생성
	...
	/*
	 * [요청 파라미터 추출방법 1] HttpServletRequest 객체를 Controller 메소드로 전달받아서 직접 추출
	 */
