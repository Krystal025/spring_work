...
public class HomeController {
	...
	public String home(HttpServletRequest request) {
		...
		noticeList.add("날이 많이 더워지고 있어요");
		noticeList.add("어쩌구...");
		noticeList.add("저쩌구 ...");
		
		// home.jsp 페이지에서 필요한 모델(data)를 HttpServletRequest객체에 담아두기 
	...
	public String fortune(HttpServletRequest request) {
		// 오늘의 운세라고 가정
		String fortuneToday = "오늘은 불금불금";
		// "fortuneToday"라는 키값으로 String type 데이터를 담음
